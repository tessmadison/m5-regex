...
public class Main {
    ...
    // DONE: Modify this code to check if the given string is non-empty, contains at least
    ...
    // DONE: Modify this method to return a list of all email addresses contained in the
    ...
    // DONE: Modify this method to check whether or not the string contains the same capital letter
